...
public class PostController {
	...
	public PostListDto list(@RequestParam(defaultValue = "1") int pageNum, PostDto search) {
		//글 목록과 검샥 키워드 관련 정보가 들어 있는 PostListDto
	...
	public PostDto view(@PathVariable(name="num") long num, PostDto dto) {
		//글 번호는 경로 변슈에, 검색 키워드가 있다면 해당 정보는 PostDto 객체에 담겨 이싿
	...
	public PostDto update(@PathVariable(value="num") long num,
	...
	public Map<String, Object> commentList(@PathVariable("num") long num,
			int pageNum){
		//필요한 정보 담고
