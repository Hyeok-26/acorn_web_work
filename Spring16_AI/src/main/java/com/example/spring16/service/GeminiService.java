...
public class GeminiService {
	//gemini api 키를 custom.properties 파일에서 읽어오가
	...
	/*
	 * 클라이언트가 입력한 내용을 이용해서 Gemini 에 질문할 새로운 질문을 만들어낸가
	 * 
	 * 대답의 형식을 구체적으로 제한한다.
	 * 
	 */
	...
	public Mono<String> getChatResponse(String prompt){
		 ...
		 */
		//위의 형식에 맞게 요청의 body 구성 {"contenrs":[{"parts":[{"text":질문}]}]}
	...
	// json 으로 응답된 내용울 추출및 병합해서 하나의 String 우로 얻어내는 유틸 메소드
