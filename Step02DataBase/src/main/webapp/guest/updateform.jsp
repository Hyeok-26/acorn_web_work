...
<%
	...
	//3. 글 수정 양식을 응답한다. 
	System.out.println("num 파라미터 값: " + request.getParameter("num"));
%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="container">
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a
					href="${pageContext.request.contextPath }/guest/list.jsp">방명록 목록</a>
				</li>
				<li class="breadcrumb-item active">내용 수정</li>
			</ol>
		</nav>
		<h1>방명록 수정 폼</h1>
		<form action="update.jsp" method="post">
			...
			<div class="mb-2">
				<label class="form-label" for="pwd">글 작성시 입력했던 번호</label>
				<input class="form-control" type="text" name="pwd" id="pwd" />
			</div>
			<button type="submit" class="btn btn-outline-success btn-sm">수정 확인</button>
